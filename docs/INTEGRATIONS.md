...
|---|---|---|
| Microsoft 365 | Not connected; delivery handoff persists as retryable/blocked | app registration, tenant consent, least-privileged mail/calendar scopes, mailbox authorization, subscriptions/delta recovery, revocation, delivery reconciliation |
