...
| Proceedings/readiness | Functional settlement-readiness slice | Immutable evaluator snapshots use current matter/injury/authority/task/records/lien/report state and classify missing data/document, client decisions, court requirements, firm preferences, and external dependencies. Conclusions stop at ready-for-human-decision/not-ready/blocked; attorney review persists and EAMS remains an explicit block. Proceeding-specific checks, exhibits/witnesses/interpreters/forms/signatures and attorney-reviewed California content remain |
