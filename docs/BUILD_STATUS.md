...
| Billing | Functional work-to-payment golden lifecycle | Versioned synthetic client rate/code profile, approved timekeeper/increment math, sourced expense, prebill lines/approval, invoice, LEDES 1998B reconciliation/hash, human-recorded submission/rejection, appeal/recovery, payment/balance/realization arithmetic, immutable decisions/events/outbox, idempotency, and tenant gates persist. Budgets/accruals/staffing/narrative detectors, profitability, write-offs, and connected accounting/e-billing providers remain. |
