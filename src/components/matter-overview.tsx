  ...
  return (
    <div className="overview-grid">
      <section className="panel posture" aria-labelledby="posture-title">
        <header className="section-heading"><h2 id="posture-title">Current posture</h2><button type="button">View analysis <ArrowUpRight size={14} /></button></header>
      ...
      <section className="panel key-financials" aria-labelledby="financial-title">
        ...
        <button className="full-button" type="button"><CircleDollarSign size={15} />Review candidate time</button>
      </section>

      <section className="panel activity" aria-labelledby="activity-title">
        <header className="section-heading"><h2 id="activity-title">Recent activity</h2><button type="button">View timeline <ArrowUpRight size={14} /></button></header>
