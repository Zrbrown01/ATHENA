...
export default function MattersPage() {
  return <AppShell active="Matters"><div className="simple-page matters-page">
    <header className="inventory-title"><div><span className="eyebrow">MATTERS</span><h1>Matter inventory</h1><p>Current posture, ownership, and upcoming obligations across the firm.</p></div><button type="button" className="primary-action"><Plus size={15} />Open matter</button></header>
