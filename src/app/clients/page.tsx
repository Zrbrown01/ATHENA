...
export default function ClientsPage(){return <AppShell active="Clients"><div className="simple-page"><ModuleHeader eyebrow="CLIENT SERVICE" title="Clients and accounts" description="Account contacts, portfolio posture, billing guidelines, reporting obligations, and portal access boundaries." /><div className="truth-banner"><Users size={18}/><div><strong>Client portal access is not enabled</strong><p>This owner-only pilot does not expose matter data to clients or other external users.</p></div></div><MetricGrid metrics={[{label:"Active clients",value:"12",detail:"Synthetic pilot",icon:Building2},{label:"Open matters",value:"48",detail:"Across accounts",icon:FileText},{label:"Client contacts",value:"31",detail:"Internal directory",icon:Users},{label:"Outstanding AR",value:"$63,420",detail:"Synthetic",icon:CircleDollarSign}]} /><WorkstreamTable title="Account portfolio" description="Metrics shown are synthetic and do not represent a connected billing or claims system." rows={rows} column="Client" /></div></AppShell>}
