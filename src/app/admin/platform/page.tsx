...
import { ClientInstructionOperations } from "@/components/client-instruction-operations";
      ...
      <div className="simple-page">
        <header className="module-title">
          <div>
            ...
            <p>
              Tenant-scoped event delivery, access isolation, retention
              safeguards, deadline calculation evidence, recovery controls, and
              bounded scale evidence for the private pilot.
            </p>
          </div>
        </header>
        <div className="truth-banner">
          <div>
            <strong>Controlled pilot boundary</strong>
            <p>
              Publishing below targets Athena’s internal event projection only.
              It does not send email, file with EAMS, update MerusCase, invoke a
              disconnected provider, or establish production readiness.
            </p>
          </div>
        </div>
        <GovernancePolicyOperations />
        <ClientInstructionOperations />
